...
nav = {
    "今日決策": [
        st.Page(today_decision.render, title="今日決策", icon="✅",
                default=True, url_path="today-decision"),
        st.Page(trade_state.render, title="交易狀態", icon="📌",
                url_path="trade-state"),
        st.Page(us_screener.render, title="暴漲股篩選器", icon="🌡",
                url_path="us-screener"),
    ...
    "資料維護": [
        st.Page(industry_roles.render, title="產業鏈分類", icon="🧬",
                url_path="industry-roles"),
